...
function minimax(board, depth: number, alpha: number, beta: number, isMaximizing) {
...
function playerTurn(player: string, alpha, beta) {
    if (isBoardFull()) {
            ...
            if (result && result.position) {
                ...
                if (validPosition(i, j)) {
                    ...
                    if (Board[i][j] === " ") {
                        ...
                        if (player === "X") playerTurn("O", alpha, beta);
                        else playerTurn("X", alpha, beta);
                    } else {
